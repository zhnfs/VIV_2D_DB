function plot_All_vrn(vrn_fr, vr_fr,Yad_fr, Xad_fr, Theta_fr, vrn_pred,vr2D_pred, Ampy_pred, Ampx_pred, theta2D_pred, freqRatio, freqRatioInd, compIndx, col, shp, outputDir)
