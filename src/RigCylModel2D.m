classdef RigCylModel2D < Fluid & RigidCylinder2D & SpringDamper2D
    ...
    methods
        function obj = RigCylModel2D(diameter, length, density_x, density_y, fluidSpeed, ...
        ...
        function PrintRigCylModel2D(obj)
            ...
            disp(['Nominal Natural Frequency Inline in water = ', num2str(obj.NominalNaturalFreq_x) ' Hz']); 
            disp(['Nominal Reduced Velocity in water Inline = ', num2str(obj.FluidSpeed/obj.Diameter/obj.NominalNaturalFreq_x)]); 
            disp(['Mass Ratio Crossflow = ', num2str(obj.MassRatio_y)]);
            disp(['Nominal Natural Frequency Crossflow in water= ', num2str(obj.NominalNaturalFreq_y) ' Hz']); 
            disp(['Nominal Reduced Velocity in water Crossflow = ', num2str(obj.FluidSpeed/obj.Diameter/obj.NominalNaturalFreq_y)]); 
            disp(' ');
