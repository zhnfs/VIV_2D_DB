    function plot_maxY(vrn_fr, vr_fr,Yad_fr, Xad_fr, Theta_fr, vrn_pred, vr_pred_MaxAmpy, Yad_pred_MaxAmpy, Xad_pred_MaxAmpy, Theta_pred_MaxAmpy, freqRatio, freqRatioInd, compIndx, col, shp, outputDir)
    ...
    grid
    suptitle('Max Ampy Prediction vs Free Virbation Experiment Data')
